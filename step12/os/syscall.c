...
kz_thread_id_t
kz_run(kz_func_t func, char *name, int priority,
...
int
kz_send(kz_msgbox_id_t id, int size, char *p)
{
	kz_syscall_param_t param;
...
kz_thread_id_t
kz_recv(kz_msgbox_id_t id, int *sizep, char **pp)
{
	kz_syscall_param_t param;
...
int
kz_setintr(softvec_type_t type, kz_handler_t handler)
{
	kz_syscall_param_t param;
...
int
kx_send(kz_msgbox_id_t id, int size, char *p)
{
	kz_syscall_param_t param;
